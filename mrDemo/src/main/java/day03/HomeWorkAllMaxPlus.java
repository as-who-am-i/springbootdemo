...
*@ClassName:DistinctJob
 ...
 @Version:v1.0
*/
public class HomeWorkAllMaxPlus {
    ...
    public static class MaxSaleReducer extends Reducer<Text, NullWritable, Text, IntWritable> {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        //设置一个任务
        Job job = Job.getInstance(coreSiteConf, "HW");
        //设置job的运行类
        job.setJarByClass(HomeWorkAllMaxPlus.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("/homeworkMaxPlusOut/"));
        //运行任务
