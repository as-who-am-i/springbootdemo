...
public class HomeWorkMax {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(HomeWorkMax.class);
        //job.setJar("mrDemo/target/mrDemo-1.0-SNAPSHOT.jar");
        //设置map和reduce处理类
        job.setMapperClass(HomeWorkMax.HWMapper.class);
        job.setReducerClass(HomeWorkMax.HWReducer.class);
        ...
        FileOutputFormat.setOutputPath(job,new Path("/homeworkOut"));
